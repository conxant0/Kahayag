...
def _panel_base(
    ...
    *,
    ...
    website: str,
    manufacturer_country: str = "China",
...
NEW_PANELS: list[dict[str, Any]] = [
    ...
    _panel_base(
        "panel_021",
        brand="Trina Solar",
        model="Vertex S+ TSM-450NEG9R.28",
        wattage_w=450,
        sku="TSM-450NEG9R.28",
        distributor="Solgen Trading, Truelight Energy",
        price_min=5600,
        price_max=7000,
        cell_technology="TOPCon",
    ...
    _panel_base(
        ...
        wattage_w=430,
        sku="REC430AA-PURE-R",
        distributor="Premium PH installers, Greenergy Solar",
        price_min=8500,
        price_max=10500,
        voc_v=40.2,
        vmp_v=33.8,
    ...
    _panel_base(
        ...
        wattage_w=450,
        sku="HS450M-54H",
        distributor="Local PH assemblers, Solaric Corp.",
        price_min=5000,
        price_max=6400,
        manufacturer_country="Philippines",
        country_of_origin="Philippines",
        website="https://www.helios-solar.ph",
    ),
    _panel_base(
        "panel_024",
        brand="SunPower",
        model="Maxeon 6 AC 425",
        wattage_w=425,
        sku="SPR-MAX6-425-AC",
        distributor="Authorized SunPower PH dealers",
        price_min=12000,
        price_max=15000,
        voc_v=40.0,
        vmp_v=33.5,
    ...
    _panel_base(
        ...
        price_min=4700,
        price_max=6100,
        website="https://www.dmegcsolar.com",
    ),
]
...
NEW_INVERTERS: list[dict[str, Any]] = [
    ...
    _inverter_base(
        ...
        dc_w=4500,
        sku="4.210.030",
        distributor="Fronius authorized PH dealers",
        price_min=85000,
        price_max=98000,
        mppt_max=600,
    ...
    _inverter_base(
        "inv_030",
        brand="LuxPower",
        model="LXP3600 Hybrid",
        inv_type="hybrid",
        ac_w=3600,
        dc_w=5400,
        sku="LXP3600",
        distributor="LuxPower PH distributors",
        price_min=45000,
        price_max=55000,
        battery_compatible=True,
        certified_batteries=["batt_012", "batt_011"],
        backup_eps=True,
    ...
    _inverter_base(
        ...
        dc_w=5550,
        sku="X1-3.7-S",
        distributor="Solax PH distributors",
        price_min=24000,
        price_max=30000,
    ...
    _inverter_base(
        ...
        price_max=65000,
        battery_compatible=True,
        certified_batteries=["batt_001", "batt_014"],
        backup_eps=True,
        website="https://www.solaxpower.com",
    ),
    _inverter_base(
        "inv_033",
        brand="Chint Power",
        model="CPS 3kW Grid-Tie",
        inv_type="grid_tie",
        ac_w=3000,
        dc_w=4500,
        sku="CPS3K-S",
        distributor="Chint Power PH distributors",
        price_min=15000,
        price_max=20000,
...
NEW_PACKAGES: dict[str, list[dict[str, Any]]] = {
    "protections": [
        ...
        },
        {
            ...
            "description": "IP65-rated combiner box with fuse holders for 2–4 PV strings",
            "price_php": _price(4500, 7500),
            "warranty": {"years": 5},
            "unit": "lot",
        },
        {
            ...
            "description": "Lockable DC disconnect switch for string inverter input side",
            "price_php": _price(2800, 4500),
            "warranty": {"years": 5},
            "unit": "pcs",
        },
        {
            ...
            "description": "PV-rated fuse holders and gPV fuses per string for overcurrent protection",
            "price_php": _price(1200, 2200),
            "warranty": {"years": 5},
            "unit": "lot",
        },
        {
            ...
            "description": "Lockable AC disconnect switch at inverter output, utility-side",
            "price_php": _price(3500, 5500),
            "warranty": {"years": 5},
            "unit": "pcs",
        },
        {
            ...
            "category": "ac_breaker",
            "description": "Main AC circuit breaker in consumer unit for solar tie-in",
            "price_php": _price(2800, 4200),
            "warranty": {"years": 5},
            "unit": "pcs",
        },
        {
            "id": "prot_010",
            "brand": "Generic",
            "model": "AC/DC Isolation Switch Kit",
            "category": "isolation_switch",
            "description": "Paired DC and AC isolation switches for safe maintenance access",
            "price_php": _price(5500, 8500),
            "warranty": {"years": 5},
            "unit": "lot",
        },
        {
            ...
            "description": "Type 2 DC-side surge protection device for PV strings up to 1000V",
            "price_php": _price(4500, 7000),
            "warranty": {"years": 5},
            "unit": "pcs",
        },
        {
            ...
            "category": "surge_protection",
            "description": "Type 2 AC-side surge protection device at inverter output",
            "price_php": _price(3800, 6000),
            "warranty": {"years": 5},
            "unit": "pcs",
        },
    ],
    "mounting_kits": [
        ...
        },
        {
            "id": "mount_005",
            "brand": "Generic",
            "model": "Pitched Roof L-Bracket Kit (per kWp)",
            "category": "mounting",
            "description": "L-brackets and rails for corrugated or shingle pitched roofs",
            "price_php_per_kwp": _price(7500, 11000),
            "warranty": {"years": 10},
            "unit": "kWp",
        },
        {
            "id": "mount_006",
            "brand": "Generic",
            "model": "Ground-Mount Racking Kit (per kWp)",
            "category": "mounting",
            "description": "Galvanized steel ground-mount frames for open-lot residential installs",
            "price_php_per_kwp": _price(14000, 20000),
            "warranty": {"years": 15},
            "unit": "kWp",
        },
        {
            "id": "mount_007",
            "brand": "IronRidge",
            "model": "XR100 Rail System (per kWp)",
            "category": "mounting",
            "description": "IronRidge XR100 aluminum rails with mid/end clamps and flashings",
            "price_php_per_kwp": _price(12000, 17000),
            "warranty": {"years": 12},
            "unit": "kWp",
        },
        {
            "id": "mount_008",
            "brand": "Generic",
            "model": "Typhoon-Rated Reinforced Mount Kit (per kWp)",
            "category": "mounting",
            "description": "Heavy-duty rails and anchors rated for Typhoon Signal 3+ coastal zones",
            "price_php_per_kwp": _price(13000, 18000),
            "warranty": {"years": 12},
            "unit": "kWp",
        },
    ],
    "cabling": [
        ...
        },
        {
            ...
            "category": "dc_wiring",
            "description": "4mm²/6mm² PV1-F DC cable with MC4 male/female connectors per string",
            "price_php_per_kwp": _price(3500, 5500),
            "warranty": {"years": 5},
            "unit": "kWp",
        },
        {
            ...
            "category": "ac_wiring",
            "description": "THHN/THWN AC cable from inverter to consumer unit with crimp lugs",
            "price_php": _price(2500, 4500),
            "warranty": {"years": 5},
            "unit": "lot",
        },
        {
            ...
            "category": "grounding",
            "description": "6 AWG bare copper grounding wire, lugs, and panel/frame bonding hardware",
            "price_php": _price(2000, 3500),
            "warranty": {"years": 5},
            "unit": "lot",
        },
        {
            ...
            "category": "conduit",
            "description": "PVC conduit, fittings, and cable trunking for roof-to-inverter runs",
            "price_php_per_kwp": _price(1500, 3000),
            "warranty": {"years": 5},
            "unit": "kWp",
        },
        {
            ...
            "category": "connectors",
            "description": "MC4 Y-branch connectors and inline fuses for parallel string wiring",
            "price_php": _price(800, 1500),
            "warranty": {"years": 5},
            "unit": "lot",
        },
    ],
    "misc_bom_items": [
        ...
        },
        {
            ...
            "category": "net_meter",
            "description": "Utility-approved bi-directional meter for Meralco net metering program",
            "price_php": _price(12000, 22000),
            "warranty": {"years": 5},
            "unit": "pcs",
        },
        {
            ...
            "category": "grounding",
            "description": "Ground rod, clamp, exothermic weld, and bonding jumpers for system grounding",
            "price_php": _price(2500, 4500),
            "warranty": {"years": 5},
            "unit": "lot",
        },
        {
            ...
            "category": "enclosure",
            "description": "IP65 wall-mount enclosure for DC disconnect, SPD, and combiner components",
            "price_php": _price(3500, 6000),
            "warranty": {"years": 5},
            "unit": "pcs",
        },
    ],
