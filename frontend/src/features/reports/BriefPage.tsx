...
export function BriefPage() {
  ...
  return (
    <ContentScreen
      ...
      backHref={ROUTE_PATHS.why}
      backLabel="Back to why this estimate"
      ctaSticky="always"
      aside={
        <>
          <section
          ...
          <SpecSection title="Financials" rows={brief.financialRows} />
    ...
    >
      <KahayagSunrise size={60} className="order-first" />
